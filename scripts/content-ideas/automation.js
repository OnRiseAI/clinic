...
const GMAIL_USER = 'meetyourclinic@gmail.com'
const GMAIL_APP_PASSWORD = 'GodisGreat11'

const OPENAI_API_KEY = process.env.OPENAI_API_KEY
const supabaseUrl = 'https://dpewhfmgipjympxlxwij.supabase.co'
...
const message = await client.fetchOne(uid, { source: true })
      ...
      try {
        ...
        console.log('Generating:', alert.query)
