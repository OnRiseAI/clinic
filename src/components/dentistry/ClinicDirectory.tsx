...
import { LOCATION_FILTERS } from "@/lib/dentistry/data";
...
export default function ClinicDirectory({ clinics }: ClinicDirectoryProps) {
  const [selectedClinic, setSelectedClinic] = useState<DentalClinic>(
    clinics[0]
  );
  ...
  const handleContact = useCallback((clinic: DentalClinic) => {
    ...
    <>
      ...
      >
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          {/* Clinic list — single column for rich horizontal cards */}
        ...
        >
          ...
          <div className="rounded-2xl border border-slate-200 bg-white shadow-lg shadow-slate-900/5 p-6 sm:p-8">
            <LeadFunnel
              ...
              pageContext="Dental treatment"
              clinicContactConfig={selectedClinic.contactConfig}
            />
          </div>

          {/* Trust signals below funnel */}
