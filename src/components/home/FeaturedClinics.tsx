      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div>
            ...
            <p className="text-navy/40 max-w-lg leading-relaxed">
            ...
            >
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-[11px] text-navy/35 mb-2">{clinic.location}</p>
                  <div className="flex items-center gap-1 mb-3">
                    ...
                    <span className="text-xs text-navy/30">({clinic.reviews})</span>
                  </div>
