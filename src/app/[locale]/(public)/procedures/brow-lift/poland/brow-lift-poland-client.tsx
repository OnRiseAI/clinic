...
interface BrowLiftPolandClientProps {
  faqs: FAQ[]
}
...
const PROCEDURES_AVAILABLE = [
  { name: 'Endoscopic Brow Lift', price: '£2,500–£3,000', description: 'Minimally invasive, small incisions' },
  { name: 'Coronal Brow Lift', price: '£3,000–£3,500', description: 'Traditional technique, dramatic results' },
  { name: 'Temporal Brow Lift', price: '£2,000–£2,500', description: 'Targets outer brow only' },
  { name: 'Direct Brow Lift', price: '£2,000–£2,500', description: 'Incision above eyebrow' },
]

export function BrowLiftPolandClient({ faqs }: BrowLiftPolandClientProps) {
  return (
    <LazyMotion features={domAnimation}>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <m.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center">
            ...
            <m.p variants={fadeInUp} className="mx-auto mt-6 max-w-3xl text-lg text-slate-600 sm:text-xl">
              Brow lift surgery from £2,500 with EU standards. Experienced facial surgeons,
              modern clinics, comprehensive packages.
            </m.p>
            <m.div variants={fadeInUp} className="mt-8 flex justify-center">
              <Link
                href="/search?procedure=brow-lift&country=poland"
            ...
            <m.div variants={fadeInUp} className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-6">
              ...
              <div className="rounded-xl bg-white p-6 shadow-md">
                <p className="text-3xl font-bold text-amber-600">50–60%</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <m.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <m.h2 variants={fadeInUp} className="text-2xl font-bold text-slate-900 sm:text-3xl">
              Why Choose Poland for Brow Lift?
            </m.h2>
            <m.div variants={fadeInUp} className="mt-6 space-y-4 text-slate-600">
              <p>
                Poland offers EU-standard medical care at significantly lower prices than the UK.
                Polish plastic surgeons are highly trained, with many holding international
                certifications and memberships in prestigious medical societies.
              </p>
              <p>
                The short flight from the UK (around 2 hours) makes Poland convenient for medical
                travel. English is widely spoken in medical settings, ensuring clear communication
                throughout your treatment journey.
              </p>
              <p>
                <strong>EU advantage:</strong> As an EU member, Poland follows strict medical
                regulations. Your consumer rights are protected, and clinics must meet rigorous
                safety standards.
              </p>
            </m.div>
          </m.div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <m.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <m.p variants={fadeInUp} className="mt-6 text-slate-600">
              <strong>Combination procedures:</strong> Add blepharoplasty (£2,000–£3,000), facelift
              (£4,000–£6,000), or fat transfer (£2,000–£3,000) for comprehensive rejuvenation.
            </m.p>
          </m.div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-12 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <m.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <m.div variants={fadeInUp} className="mt-6 space-y-4 text-slate-600">
              <p>
                Poland's medical facilities meet strict EU safety standards. When choosing a clinic
                for brow lift:
              </p>
      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <m.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <m.h2 variants={fadeInUp} className="text-2xl font-bold text-slate-900 sm:text-3xl">
              Where to Get Brow Lift in Poland
            </m.h2>
            <m.div variants={fadeInUp} className="mt-8 grid gap-6 sm:grid-cols-2">
              <div className="rounded-xl border border-slate-200 bg-white p-6">
                ...
                <p className="mt-2 text-slate-600">
                  The capital city has the largest selection of cosmetic surgery clinics and
                  experienced facial surgeons. Modern facilities and excellent transport links.
                </p>
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-6">
                <div className="flex items-center gap-2">
                  <MapPin className="h-5 w-5 text-amber-600" />
                  <h3 className="text-xl font-bold text-slate-900">Krakow</h3>
                </div>
                <p className="mt-2 text-slate-600">
                  Beautiful historic city with quality clinics. A popular choice for patients
                  who want to combine treatment with exploring a UNESCO World Heritage city.
                </p>
                <p className="mt-2 text-sm font-medium text-amber-600">10+ clinics · 2.5 hours from London</p>
              </div>
            </m.div>
          </m.div>
        </div>
          ...
          <m.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <m.div variants={fadeInUp} className="mt-8 space-y-4">
              ...
              <div className="rounded-lg border border-slate-200 bg-white p-4">
                ...
                <span className="ml-2 text-slate-600">Maximum swelling/bruising, cold compresses, rest at hotel</span>
              </div>
              <div className="rounded-lg border border-slate-200 bg-white p-4">
                <span className="font-semibold text-amber-600">Days 4–5:</span>
                <span className="ml-2 text-slate-600">Swelling begins to subside, light walking, explore the city</span>
              </div>
              <div className="rounded-lg border border-slate-200 bg-white p-4">
            ...
            <m.p variants={fadeInUp} className="mt-6 text-slate-600">
              The short flight home (2 hours) is easier on recovery compared to longer journeys.
              Most patients feel comfortable returning to normal activities within 1–2 weeks.
            </m.p>
          </m.div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-amber-600 to-amber-800 py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-white sm:text-3xl">Ready to Compare Brow Lift Clinics in Poland?</h2>
          <p className="mx-auto mt-4 max-w-2xl text-amber-100">
            Browse verified clinics with EU-certified surgeons.
          </p>
          <div className="mt-8">
            <Link
              href="/search?procedure=brow-lift&country=poland"
      ...
      <section className="border-t border-slate-200 py-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 text-sm text-slate-600">
            ...
            <Link href="/procedures/blepharoplasty/poland" className="text-amber-600 hover:underline">Eyelid Surgery Poland</Link> ·{' '}
            <Link href="/destinations/poland" className="text-amber-600 hover:underline">Poland Guide</Link>
          </p>
        </div>
      </section>
    </LazyMotion>
