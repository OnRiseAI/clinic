...
interface FaceliftPolandClientProps {
  faqs: FAQ[]
}
...
export function FaceliftPolandClient({ faqs }: FaceliftPolandClientProps) {
  return (
    <LazyMotion features={domAnimation}>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <m.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center">
            ...
            <m.p variants={fadeInUp} className="mx-auto mt-6 max-w-3xl text-lg text-slate-600 sm:text-xl">
              Facelift surgery from £4,000 with EU standards. Natural results,
              short flights, full patient protections.
            </m.p>
            <m.div variants={fadeInUp} className="mt-8 flex justify-center">
              <Link
                href="/search?procedure=facelift&country=poland"
            ...
            <m.div variants={fadeInUp} className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-6">
              <div className="rounded-xl bg-white p-6 shadow-md">
                <p className="text-3xl font-bold text-blue-600">£4,000–£6,000</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <m.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <m.h2 variants={fadeInUp} className="text-2xl font-bold text-slate-900 sm:text-3xl">
              Why Choose Poland for Facelift?
            </m.h2>
            <m.div variants={fadeInUp} className="mt-6 space-y-4 text-slate-600">
              <p>
                Poland offers facelift surgery with full EU patient protections — the same
              ...
              <p>
                The short 2-hour flight makes Poland particularly practical for facelift, which
                has a longer visible recovery than other procedures. Easy travel means less
                stress during the critical healing period.
              </p>
            </m.div>
          </m.div>
        </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <m.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <m.div variants={fadeInUp} className="mt-6 space-y-4 text-slate-600">
              <p>Polish surgeons offer comprehensive facial rejuvenation options:</p>
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-2">
                  <CheckCircle className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" />
                  <span><strong>Full Facelift (£5,000–£6,000):</strong> Comprehensive face and neck rejuvenation</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" />
                  <span><strong>Mini Facelift (£4,000–£5,000):</strong> Lower face focus, shorter recovery</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" />
                  <span><strong>Neck Lift (£3,000–£4,000):</strong> Addresses neck bands and sagging</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" />
                  <span><strong>Combination procedures:</strong> Add blepharoplasty or brow lift</span>
                </li>
              </ul>
            </m.div>
          </m.div>
      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <m.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <m.h2 variants={fadeInUp} className="text-2xl font-bold text-slate-900 sm:text-3xl">
              Where to Get Facelift in Poland
            </m.h2>
      ...
      <section className="bg-slate-50 py-12 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <m.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <m.div variants={fadeInUp} className="mt-6 space-y-4 text-slate-600">
              <p>
                Plan to stay in Poland for 10–14 days. The short 2-hour flight home is a
                significant advantage for facelift recovery — less time traveling while
                swollen and bruised.
              </p>
              <p>
                Stitches are typically removed at day 7–10. After stitch removal, you're
                cleared to fly home. Some bruising may still be visible but can be covered
                with makeup.
              </p>
              <p>
                Full recovery takes 2–3 weeks before you're socially presentable. Final
                results continue improving over 3–6 months as swelling fully resolves.
              </p>
            </m.div>
          </m.div>
        </div>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-white sm:text-3xl">Ready to Compare Facelift Clinics in Poland?</h2>
      ...
      <section className="border-t border-slate-200 py-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-sm text-slate-600">
            ...
            <Link href="/procedures/facelift/turkey" className="text-blue-600 hover:underline">Turkey</Link> ·{' '}
            <Link href="/procedures/facelift/spain" className="text-blue-600 hover:underline">Spain</Link> ·{' '}
            <Link href="/procedures/facelift/hungary" className="text-blue-600 hover:underline">Hungary</Link>
          </p>
          <p className="mt-2 text-sm text-slate-600">
            <strong>Related:</strong>{' '}
            <Link href="/procedures/facelift" className="text-blue-600 hover:underline">Facelift Overview</Link> ·{' '}
            <Link href="/procedures/blepharoplasty/poland" className="text-blue-600 hover:underline">Eyelid Surgery Poland</Link> ·{' '}
